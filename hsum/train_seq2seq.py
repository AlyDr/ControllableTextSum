...
MODEL_CLASSES = {"mbart": (MBartConfig,
                          single_head_utils.ConditionalGenerationCustomMBart,
                          MBartTokenizer),
                 "mbart_subpop": (MBartConfig,
                                 single_head_utils.ConditionalGenerationCustomMBart,
                                 MBartTokenizer),
                 "mbart_mult_heads_3": (MBartConfig,
                                       multi_head_utils_3.ConditionalGenerationCustomMBartMultHeads,
                                       MBartTokenizer),
                 "mbart_mult_heads_2": (MBartConfig,
...
def evaluate(args, eval_dataset, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, prefix="") -> Dict:
    ...
    with torch.no_grad():
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            if args.model_type in ['mbart_mult_heads_2', 'mbart_mult_heads_3']:
